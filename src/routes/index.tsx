...
function initMetaPixel() {
  ...
  // @ts-expect-error fbq injetado pelo script
...
function trackWhatsAppClick(source: string) {
  ...
  // @ts-expect-error fbq injetado pelo script do Meta Pixel
  ...
  return (
    <main className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative bg-gradient-hero text-white overflow-hidden">
        {/* decorative glow */}
        <div className="pointer-events-none absolute -top-32 -right-32 w- h- rounded-full bg-white/10 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-40 -left-32 w- h- rounded-full bg-[oklch(0.55_0.24_330_/_0.4)] blur-3xl" />
          ...
          <header className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div className="leading-tight">
                ...
                <div className="text- uppercase tracking-widest text-white/80">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center mt-8 sm:mt-12">
            <div className="animate-fade-in-up">
              ...
              <h1 className="font-display font-black text-4xl sm:text-5xl lg:text-6xl leading-[1.05] tracking-tight">
                Seja Técnico em <span className="block text-transparent bg-clip-text bg-gradient-to-r from-white to-[oklch(0.92_0.08_70)]">até 48 horas</span>
              </h1>
              ...
              <p className="mt-4 text-sm text-white/80">
                Mais de <strong className="text-white">44 mil alunos</strong> acompanham a FORMAX.
                Atendimento individual, suporte especializado e formação reconhecida.
              </p>
              ...
              <div className="mt-7 flex flex-wrap gap-x-5 gap-y-2 text-xs text-white/85">
                <span className="inline-flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4" /> 100% Online</span>
                <span className="inline-flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4" /> Suporte WhatsApp</span>
                <span className="inline-flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4" /> Diploma Reconhecido</span>
              </div>
            </div>
      ...
      <section className="relative py-16 sm:py-24 bg-gradient-brand-soft overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-5 text-center">
          ...
          <p className="mt-5 text-lg text-foreground/80 max-w-2xl mx-auto">
            Conquiste novas oportunidades profissionais, aumente sua renda e dê o próximo
            passo na carreira que você sempre sonhou.
          </p>
        ...
        <div className="max-w-5xl mx-auto px-5 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              Milhares de pessoas conquistando seus diplomas e transformando suas carreiras
              todos os dias. Faça parte dessa comunidade.
            </p>
            ...
            <div className="mt-7 flex flex-col sm:flex-row gap-3">
              ...
              <WhatsAppButton source="instagram" variant="primary">FALAR COM A BRENDA</WhatsAppButton>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
              ...
              <div className="flex-1">
                <h3 className="font-display font-extrabold text-xl sm:text-2xl">
                  Atendimento limitado para novos alunos
                </h3>
                <p className="mt-1 text-muted-foreground text-sm sm:text-base">
                  Turmas em andamento. A Brenda atende por ordem de chegada — garanta seu
                  atendimento agora antes que as vagas se encerrem.
                </p>
              </div>
              <WhatsAppButton source="urgencia" className="shrink-0">FALAR AGORA</WhatsAppButton>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-20 sm:py-28 bg-gradient-hero text-white overflow-hidden">
        <div className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w- h- rounded-full bg-white/10 blur-3xl" />
        <div className="relative max-w-3xl mx-auto px-5 text-center">
          ...
          <p className="mt-4 text-lg text-white/90 max-w-xl mx-auto">
            Descubra a melhor forma de conquistar sua formação técnica reconhecida ou
            concluir seu EJA online. Atendimento humano, rápido e sem compromisso.
          </p>
          ...
          <p className="mt-6 text-sm text-white/80">
            📱 (31) 99502-3091 • Atendimento humanizado pela Brenda
          </p>

          <div className="mt-10 flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs text-white/80">
            <span className="inline-flex items-center gap-1.5"><ShieldCheck className="h-4 w-4" /> Empresa séria e consolidada</span>
            <span className="inline-flex items-center gap-1.5"><Award className="h-4 w-4" /> Diploma reconhecido</span>
            <span className="inline-flex items-center gap-1.5"><Users className="h-4 w-4" /> +44 mil alunos</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              ...
              <div className="text- uppercase tracking-widest">Formação Técnica e Superior</div>
            </div>
          </div>
...
function Stat({ label, value }: { label: string; value: string }) {
  return (
    <div className="bg-white/80 backdrop-blur rounded-2xl p-3 text-center border border-white/60 shadow-card">
      ...
      <div className="text- uppercase tracking-wider text-muted-foreground">{label}</div>
    </div>
  );
}